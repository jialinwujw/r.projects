---
title: "Myocardial Infarction (MI) Survival Analysis"
output:
  html_document:
    df_print: paged
    toc: yes
...
The HR represents the ratio of the hazard of the event occurring in the exposed group to the hazard of the event occurring in the unexposed group. An HR greater than 1 indicates that the exposed group has a higher hazard of the event occurring than the unexposed group. An HR less than 1 indicates that the exposed group has a lower hazard of the event occurring than the unexposed group.

The CI represents the range of values within which the true HR is likely to fall. A wider CI indicates greater uncertainty in the estimate of the HR, whereas a narrower CI indicates greater precision.

In the HR plot, each variable in the model is represented by a horizontal line with a point estimate for the HR and a horizontal line for the CI. If the line crosses the vertical line at 1, the effect is not statistically significant. If the line falls entirely to one side of the vertical line, the effect is statistically significant.
